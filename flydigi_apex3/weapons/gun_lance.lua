local weapon_name = "GunLance"
local weapon_type = 6

local sdk_weapon_type = sdk.find_type_definition("snow.player.GunLance")
local charge_field = sdk_weapon_type:get_field("_ChargeDragonSlayCannonMaxTime")
